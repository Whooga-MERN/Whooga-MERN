      ...
      {({ signOut, user }) => {
        ...
        return (
          <div className="flex justify-center items-center h-screen">
            {(user) ? (
              // <p className="text-lg">Redirecting...</p> /* While redirecting, show this message */
              <div role="status">
                  <svg aria-hidden="true" className="inline w-[50px] h-[50px] text-gray-200 animate-spin dark:text-gray-600 fill-yellow-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-lg">Sign in below:</p> /* This will show before sign-in */
            )}
        </div>
        );
      }}
