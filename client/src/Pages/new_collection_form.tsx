  ...
  const handleContinue = async () => {
    ...
    if (imageUpload) {
      ...
      try {
        ...
        const response = await fetch(buildPath(`s3/upload`), {
          method: "POST",
          headers: {
    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col justify-center">
          <label htmlFor="collectionName" className=" font-semibold text-lg">
            Collection Name
          </label>
          <p className="text-red-500 text-md">
            {isNameEmpty ? "* Please enter a name for your collection *" : ""}
          </p>
      ...
      <div className="flex items-center mt-6">
        ...
        <div className="flex flex-col justify-center mt-8">
          <div className="flex">
            <label
              ...
              className=" font-semibold text-lg"
            >
              Describe this collection's items
            </label>
          ...
          <dialog id="my_modal_3" className="modal">
            <div className="modal-box">
              ...
              <p className="py-4">
                These attribute tags refer to what you would like to view, sort,
                ...
                automatically add an "owned" column ("T" or "F") for if you own the
                item or not.
              </p>
            </div>
          </dialog>
          <p className="text-red-500 text-md">
            {isFeaturesEmpty
              ? "* Please enter at least one item attribute *"
              : ""}
          </p>
        ...
        <div className="flex flex-wrap mt-2">
          {featureTags.map((tag, index) => (
            <div
              key={index}
              className="flex items-center bg-primary text-gray-600 font-semibold text-lg rounded-md pl-4 pr-2 py-1 mr-3 mt-2"
            >
              {tag}
              <button className="pl-4 " onClick={() => deleteFeatureTag(tag)}>
                <IoMdClose />
              </button>
            </div>
          ))}
