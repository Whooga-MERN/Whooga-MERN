...
function Header() {
  ...
  //     { x: 0, y: 0 },
  //     { x: 0, y: Zdog.TAU },
  //     { x: Zdog.TAU, y: Zdog.TAU },
  //   ];
  //   let viewRotation = new Zdog.Vector();
  //   let maxTicks;
  //   let displaySize;
  
  //   function initializeIllustration() {
  ...
  //     const colorWheel = [eggplant, garnet, orange, gold, yellow];
  ...
  //     maxTicks = 1 * cycleCount * (keyframes.length - 1); // 2 full spins
  //   }
  ...
  //   function update() {
  //     const Zdog = window.Zdog; // Ensure Zdog is available in your environment
  //     const progress = ticker / cycleCount;
  //     const tween = Zdog.easeInOut(progress % 1, 4);
  //     const turn = Math.floor(progress % (keyframes.length - 1));
  ...
  //     illo.clear(); // Clear previous illustration
  //     initializeIllustration(); // Reinitialize on resize
  //     ticker = 0; // Reset animation ticker
  ...
  //     illo?.clear(); // Cleanup Zdog illustration
  //   };
  // }, []);
      ...
      {({ signOut }) => (
        <div className="navbar bg-primary">
          <div className="flex-1">
            ...
            {/* <svg className="illo h-48 w-full"></svg> */}
          </div>
