...
const users = pgTable('users', {
  ...
  userProfilePic: varchar('userProfilePic', { length: 2048 })
});
...
const collections = pgTable('collections', {
  ...
  collectionPic: varchar('collectionPic', { length: 2048 })
});
...
const collectionUniverses = pgTable('collectionUniverses', {
  ...
  universeCollectionPic: varchar('universeCollectionPic', { length: 2048 })
});
...
const collectables = pgTable('collectables', {
  ...
  collectablePic: varchar('collectablePic', { length: 2048 })
});
...
const universeCollectables = pgTable('universeCollectables', {
  ...
  name: varchar('name', { length: 255 }).notNull(),
  universeCollectablePic: varchar('universeCollectablePic', { length: 2048} )
});
